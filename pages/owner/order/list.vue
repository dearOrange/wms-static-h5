...
import Search from '@/components/owner/order/list/Search'
import Filters from '@/components/owner/order/list/Filters'
import Result from '@/components/owner/order/list/Result'
...
export default {
  ...
  beforeMount() {
    if (this.$route.params.data) {
      ...
      this.query.orderStatusList = this.$route.params.data
      // this.filtersConfirm()
    }
  },
  methods: {
