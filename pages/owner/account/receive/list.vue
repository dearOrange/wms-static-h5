<template>
  <wms-drawer-layout ref="listDrawer" reverse :enable="false" @mask-click="toggleDrawer(false)">
    <div slot="content">
      <wms-header title="应收账单列表" backIcon>
        <template slot="left">
...
import Search from '@/components/owner/account/receive/list/search'
import Result from '@/components/owner/account/receive/list/result'
