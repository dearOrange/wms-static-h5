  ...
  <div class="goods-card">
    ...
    <div class="card-bd">
      <div class="goods--amount">
        ...
        <div v-if="params === 'order'" class="amount--item">
          <span class="name">销售数量</span>
          <span class="value">{{ data.businessReportQtySum || 0 }}</span>
        </div>
        <div v-if="params === 'order'" class="amount--item">
          <span class="name">销售金额</span>
          <span class="value">{{ data.businessReportAmountSum | CNY }}</span>
        </div>
        <div v-if="params === 'return'" class="amount--item">
