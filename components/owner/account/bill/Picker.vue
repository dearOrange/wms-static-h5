...
export default {
  ...
  computed: {
    showStartDate() {
      return this.$format(this.filters.billDateBegin, DateStyle)
    },
    showEndDate() {
      return this.$format(this.filters.billDateEnd, DateStyle)
    },
    hasStartDate() {
      return !!this.filters.billDateBegin
    },
    hasEndDate() {
      return !!this.filters.billDateEnd
    }
  },
  ...
  methods: {
    openStartPicker() {
      ...
      if (this.hasStartDate) {
        this.pickerDate = new Date(this.filters.billDateBegin)
      }
      if (this.hasEndDate) {
        this.maxDate = new Date(this.filters.billDateEnd)
      }
    ...
    openEndPicker(type, currentDate) {
      ...
      if (this.hasEndDate) {
        this.pickerDate = new Date(this.filters.billDateEnd)
      }
      if (this.hasStartDate) {
        this.minDate = new Date(this.filters.billDateBegin)
      }
      this.$refs.picker.open()
    },
